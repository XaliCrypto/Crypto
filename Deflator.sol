//Deflator token has a burn function which on every transaction sends 1% of the transaction amount to the burn address. 
...
contract Deflater is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Deflater";
  string constant tokenSymbol = "DEFLA";
